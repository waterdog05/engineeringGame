...
void setup() {
  ...
  MsTimer2::set(1250, stopCountPush);  //game play time = 20sec
}
...
void loop() {
  ...
  if (startButtonState == HIGH) {
    ...
    for (;;) {
      ...
      if (i == 15) {  //set i to break for(;;) in line 67
        i = 0;
        break;
      }
    }
    ...
    lcd.setCursor(4, 2);
    lcd.print(cntFirstPWin);  //print win num
    lcd.setCursor(9, 2);
    lcd.print("vs");
    lcd.setCursor(15, 2);
    lcd.print(cntSecondPWin);
...
void moveBelt() {
  ...
  buttonPushCounter1 = 0;  //reset buttonPushCounter
